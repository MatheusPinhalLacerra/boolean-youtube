            ...
            <div class="row">
                ...
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5">
                        ...
                        <x-adminlte-input name="data_nasc" placeholder="Data de Nascimento *"
                            value="{{ $profile->dt_birth ?? old('email') }}">
                            <x-slot name="prependSlot">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-6">
                                <x-adminlte-input name="rg" placeholder="RG *" value="{{ $profile->RG ?? old('RG') }}">
                                    <x-slot name="prependSlot">
                            ...
                            <div class="col-6">
                                <x-adminlte-input id='cpf' name="cpf" placeholder="CPF *"
                                    data-inputmask-regex="^\d{3}\.\d{3}\.\d{3}\-\d{2}$" data-mask
                                    value="{{ $profile->CPF ?? old('CPF') }}">
                                    <x-slot name="prependSlot">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-1">
                                    ...
                                    <select class="form-control" name="sexo"
                                        value="{{ $profile->genre ?? old('genero') }}">

                                        @foreach (array("Indefinido","Masculino","Feminino") as $genre)
                                            @if (isset($profile->genre) && $profile->genre == $genre)
                        ...
                        <div class="mt-5">
                            <div class="row justify-content-between">
                                <div class="col-8">
                                    <x-adminlte-input id="cepInserted" name="cep" placeholder="Cep"
                                        value="{{ $profile->CEP ?? old('CEP') }}">
                                        <x-slot name="prependSlot">
                                ...
                                <div class="col-4">
                                    <button id="cepButton" class="btn btn-labeled btn-default"
                                        onclick="consultarCep(event)">
                                        <i id="cepSearch" class="fas fa-search"></i> Pesquisar
                                    </button>
                                </div>
                            </div>

                            <x-adminlte-input id="end_logradouro" name="end_logradouro" placeholder="Endereço"
                                rows="2" value="{{ $profile->address ?? old('Endereço') }}">
                                <x-slot name="prependSlot">
                                ...
                                <x-adminlte-input type="text" name="end_num" placeholder="Número"
                                    value="{{ $profile->house_number ?? old('Numero') }}">
                                    <x-slot name="prependSlot">
                                ...
                                <x-adminlte-input name="end_complemento" placeholder="Complemento"
                                    value="{{ $profile->complement ?? old('Complemento') }}">
                                    <x-slot name="prependSlot">
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-3">
                                        <x-adminlte-input id="end_estado" name="end_estado" placeholder="Estado"
                                            value="{{ $profile->state ?? old('Estado') }}" />
                                    </div>
                                </div>
                        </div>
                ...
                <div class="col-md-4 border-right">
                    <div class="p-3 py-5">
                        ...
                        <x-adminlte-input type="email" id='email' name="email" placeholder="Email"
                            onblur="validateEmail(this)" value="{{ $user->email }}">
                            <x-slot name="prependSlot">
                        ...
                        <x-adminlte-input type="password" id='confirmpassword' name="password_confirmation"
